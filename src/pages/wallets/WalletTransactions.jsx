...
export default function WalletTransactions() {
  return (
    <div className=" bg-white mt-4 shadow-sm rounded-xl">
      <div className="px-4 py-2 sm:px-6 lg:px-4 flex justify-between sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold mt-1 text-gray-900">
            Recent transactions
          </h1>
        </div>
        <div className=" sm:ml-16 sm:mt-4 sm:flex-none">
          <button
            type="button"
            className="block rounded-md  px-3 py-2 text-center text-sm border font-normal text-gray-500 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            See all
          </button>
        </div>
      </div>
        ...
        <div className=" -my-2 mb-3 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-100 mr-3">
                <tr className="">
                  <th
                    scope="col"
